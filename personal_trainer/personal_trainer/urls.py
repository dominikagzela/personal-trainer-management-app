...
from management_app.views import (
    ...
    PlanUserView,
    PlanForUserView,
    PlanCreateExerciseView,
    PlanUpdateExerciseView,
    PlanDeleteExerciseView,
    PlanAddExerciseView,
    MacroElementsUserView,
    MacroElementsTrainerView,
    UpdateMacroElementsView,
    CreateMacroElementsView,
...
urlpatterns = [
    ...
    path('plan_for_user/<int:user_id>/', PlanForUserView.as_view(), name='plan-for-user'),
    path('plan_create_for_user/<int:user_id>/', PlanCreateExerciseView.as_view(), name='plan-create-for-user'),
    path('plan_update_exercise/<int:user_id>/<int:training_number>/<int:exercise_id>/<int:plan_pk>/',
         PlanUpdateExerciseView.as_view(), name='plan-update-exercise'),
    path('plan_delete_exercise/<int:user_id>/<int:pk>/', PlanDeleteExerciseView.as_view(),
         name='plan-delete-exercise'),
    path('plan_add_exercise/<int:user_id>/<int:training_number>/', PlanAddExerciseView.as_view(),
    ...
    path('create_macro_elements/<int:user_id>/', CreateMacroElementsView.as_view(),
         name='create-macro-elements'),
